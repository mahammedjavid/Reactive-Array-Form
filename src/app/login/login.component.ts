...
export class LoginComponent implements OnInit {
  ...
  loggedIn!: boolean;
  ngOnInit(): void {
    this.apiService.getLoginGoogle().subscribe((x) => {
      this.user = x
      this.loggedIn = (x != null);
      this.apiService.subject.next(this.loggedIn)
      if (!this.loggedIn) {
